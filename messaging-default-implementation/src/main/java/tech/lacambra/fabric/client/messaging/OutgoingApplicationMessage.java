...
public class OutgoingApplicationMessage {

  private JsonObject headers;
  private JsonObject body;

  public OutgoingApplicationMessage(JsonObject message) {
    this(message.getJsonObject("headers"), message.getJsonObject("body"));
  }

  public OutgoingApplicationMessage(JsonObject headers, JsonObject body) {
