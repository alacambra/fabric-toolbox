...
public class JsonBigDecimalMessageConverter implements MessageConverter {
  ...
  public boolean canConvert(Class inputType, Type inputParametrizedType, Class outputType, Type outputParametrizedType) {
    return (JsonNumber.class.equals(inputType) && outputType.equals(BigDecimal.class));
  }

  @Override
  public Object convert(Object o, Class outputType, Type outputParametrizedType) {
    return ((JsonNumber) o).bigDecimalValue();
  }
}
